...
import { LoginAction, ApiRequestFailureAction, ApiRequestStartAction, ApiRequestSuccessAction, SetVotesAction, AddVoteAction, UpdateVoteAction } from './actions';
...
export function votesReducer(state: VotesState = [],
